...
import dietTrackerApplication.DTO.UserDTO;
...
public class UserController {
	...
	@GetMapping("/userwithmealsdetails")
	public ResponseEntity<?> usersWithMealDetails(){
		response=service.usersWithMealDetails();
		List<UsersWithMealDetails> listUsers=response.getUsersWithMeal();
